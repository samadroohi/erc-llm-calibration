...
<<<
    Remember that you always respond with just the most accurate emotion
        label from the list of emotion lables: [neutral], [disappointed], [dissatisfied], [apologetic], [abusive], [excited], [satisfied], inside square brackets, without any explanations or notes. 
